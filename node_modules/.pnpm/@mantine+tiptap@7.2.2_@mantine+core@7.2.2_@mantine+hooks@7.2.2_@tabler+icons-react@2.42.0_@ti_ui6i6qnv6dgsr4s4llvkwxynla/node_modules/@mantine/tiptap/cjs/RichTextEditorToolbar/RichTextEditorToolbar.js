...
const RichTextEditorToolbar = core.factory((_props, ref) => {
  ...
  const _a = props, { classNames, className, style, styles, vars, sticky, stickyOffset } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "vars", "sticky", "stickyOffset"]);
...
RichTextEditorToolbar.classes = RichTextEditor_module['default'];
