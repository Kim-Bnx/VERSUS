import { BoxProps, CompoundStylesApiProps, ElementProps, FactoryPayload, Factory } from '../../core';
...
export declare const TableTd: import("../../core").MantineComponent<{
    props: TableTdProps;
    ref: HTMLTableCellElement;
    stylesNames: 'td';
    compound: true;
}>;
export declare const TableTr: import("../../core").MantineComponent<{
    props: TableTrProps;
    ref: HTMLTableRowElement;
    stylesNames: 'tr';
    compound: true;
}>;
export declare const TableThead: import("../../core").MantineComponent<{
    props: TableTheadProps;
    ref: HTMLTableSectionElement;
    stylesNames: 'thead';
    compound: true;
}>;
export declare const TableTbody: import("../../core").MantineComponent<{
    props: TableTbodyProps;
    ref: HTMLTableSectionElement;
    stylesNames: 'tbody';
    compound: true;
}>;
export declare const TableTfoot: import("../../core").MantineComponent<{
    props: TableTfootProps;
    ref: HTMLTableSectionElement;
    stylesNames: 'tfoot';
    compound: true;
}>;
export declare const TableCaption: import("../../core").MantineComponent<{
    props: TableCaptionProps;
    ref: HTMLTableCaptionElement;
    stylesNames: 'caption';
    compound: true;
