...
function CheckIcon(_a) {
  ...
  const _style = size !== void 0 ? __spreadValues({ width: rem.rem(size), height: rem.rem(size) }, style) : style;
...
function CheckboxIcon(_c) {
  ...
  if (indeterminate) {
    return /* @__PURE__ */ React__default.createElement(
      ...
      /* @__PURE__ */ React__default.createElement("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
    );
  }
