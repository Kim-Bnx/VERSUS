...
import classes from './Checkbox.module.mjs';
...
const Checkbox = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues({}, getStyles("inner")), { mod: { "data-label-position": labelPosition } }), /* @__PURE__ */ React.createElement(
      Box,
    ...
    ), /* @__PURE__ */ React.createElement(Icon, __spreadValues({ indeterminate }, getStyles("icon"))))
  );
});
Checkbox.classes = __spreadValues(__spreadValues({}, classes), InlineInputClasses);
